...
**This means every bootstrap file burns tokens on every single API call.** Bloated files directly increase cost. The official docs specifically warn about MEMORY.md: _"Keep them concise — especially MEMORY.md, which can grow over time and lead to unexpectedly high context usage and more frequent compaction."_
