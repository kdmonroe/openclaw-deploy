...
> Multi-Coach Mode. Huyang reads `coach-villagence/SKILL.md` and channels IG-11's voice
> for the duration of the turn. The schedules and message bodies are otherwise unchanged.
> Each `--message` is prefixed with
> `Channel IG-11 (🛡️) — read coach-villagence/SKILL.md and run this in IG-11's voice. ...`.
